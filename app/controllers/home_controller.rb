class HomeController < ApplicationController
  def index
    ...
    @url = 'http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=90001&distance=0&API_KEY=96A38DFD-5C56-4740-AD99-E38C0C855A1B'
    @uri = URI(@url)
